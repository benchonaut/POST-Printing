...
print('<form method="POST" action="'.curPageURL().'?action=NoRotFront" onchange="document.getElementById(\'NoRotFront\').form.submit()"> <button name="NoRotFront" id="NoRotFront" value="Front">Straight Front</button></form>');
print('</td><td><form method="POST" action="'.curPageURL().'?action=RotFront" onchange="document.getElementById(\'RotFront\').form.submit()"> <button name="RotFront" id="RotFront" value="Front">Rotate Front</button></form>');
print('</td><td><form method="POST" action="'.curPageURL().'?action=NoRotBack" onchange="document.getElementById(\'NoRotBack\').form.submit()"> <button name="NoRotBack" id="NoRotBack" value="Back">Straight Back</button></form>');
print('</td><td><form method="POST" action="'.curPageURL().'?action=RotBack" onchange="document.getElementById(\'RotBack\').form.submit()"> <button name="RotBack" id="RotBack" value="Back">Rotate Back</button></form>');
print('</td></tr></table>');
